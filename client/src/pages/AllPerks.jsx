...
export default function AllPerks() {
  ...
  useEffect(() => {
    // Set up a small delay to prevent calling the API on every keystroke
  ...
  function handleSearch(e) {
    e.preventDefault()
    loadAllPerks() // manual trigger (instant search)
  }
    ...
    <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setMerchantFilter(e.target.value)} // ✅ controlled select
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {perks.map(perk => (
          <Link
            key={perk._id}
            to={`/perks/${perk._id}`} // ✅ link to perk details
